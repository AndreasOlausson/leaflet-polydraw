 ...
 */
export function createButtons(container: HTMLElement, subContainer: HTMLElement, onActivateToggle: () => void, onDrawClick: () => void, onSubtractClick: () => void, onEraseClick: () => void, onStartClick: (() => void) | null, onHoleClick: (() => void) | null) {
