...
- Demo build now prevents iOS page scroll/viewport takeover while dragging the map (locked scroll + dynamic viewport units).

## [1.3.1] - 2026-01-26

### Fixed

- Corrected the `build:types` export line so published types include `leafletAdapter` and `defaultConfig`.
