...
| &nbsp;&nbsp;method                                                 | string  | `"concaveman"`<sup>\*2</sup>   | Creation method.                                                                                                                                         |
...
<sup>*1</sup>, <sup>*2</sup>  
The following notes apply to both footnotes *1 and *2 and explain the behavior referenced in the configuration table:
...
Because of this, `kinks` has no effect when using `concaveman`.<sup>*1</sup><sup>*2</sup>
